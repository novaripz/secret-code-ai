    ...
    <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-[var(--surface-0)]">
      <div className="flex h-8 shrink-0 items-center gap-2 border-b border-[var(--line)] px-2">
        ...
        <button
          ...
          title={closeLabel}
          className="tap-sq inline-flex items-center justify-center shrink-0 rounded p-1 text-[var(--text-faint)] transition-colors motion-reduce:transition-none hover:bg-[var(--surface-2)] hover:text-[var(--text)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)]"
        >
